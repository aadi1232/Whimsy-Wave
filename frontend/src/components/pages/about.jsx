...
function About() {
  return (
    <>
      <div className="text-center pt-24 px-4 md:px-0">
        {/* Title */}
        <h1 className="text-5xl md:text-6xl font-bold font-serif py-10 text-gray-900 dark:text-gray-100">
          About Me
        </h1>
      ...
      <div className="px-4 md:px-6 bg-gray-100 dark:bg-gray-900 transition-colors duration-500">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-10">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-3xl md:text-4xl font-semibold mb-2 text-gray-800 dark:text-gray-200">Aadi Patel</h2>
            <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 mb-4">Tech Enthusiast | Problem Solver | Innovator</p>

            {/* Description Section */}
            <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed italic font-serif">
            ...
            <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed mt-4 italic font-serif">
        ...
        <div className="mt-16 max-w-5xl mx-auto">
          <h3 className="text-3xl md:text-4xl font-bold font-serif py-10 text-gray-900 dark:text-gray-100 text-center">What I Like to Do</h3>
          <div className="w-36 md:w-48 mx-auto border-t-4 border-gray-300 dark:border-gray-600"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Left column: Skills */}
            <div className='pt-3.5'>
              <h4 className="text-xl md:text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-3 font-mono">Core Skills</h4>
              <ul className="space-y-2 text-lg md:text-xl text-gray-700 dark:text-gray-300 italic font-serif">
            ...
            <div>
              <h4 className="text-xl md:text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-2">Hobbies</h4>
              <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed italic font-serif pb-24">
